...
<body>
        ...
        <div class="container-fluid" style = "padding-top: 30px;">
                <div class="row">
                    ...
                    <div class="col-10 rounded-pill" style = "padding-top : 10px;padding-bottom : 10px; background-color : #006430;">
                        ...
                        <form method="GET" action="Listederoulante.php" style ="margin-left : 10px;border-top-radius: 10px; border-bottom-radius: 10px;">
                            ...
                            <div class ="rounded-pill" style="font-size: 15px;font-family: lobster; color : white;background-color: #006430;">                 
